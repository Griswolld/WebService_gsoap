...
/* myWeather.h
   Generated by wsdl2h 2.8.70 from http://www.webxml.com.cn/WebServices/WeatherWebService.asmx?wsdl and myTypemap.dat
   2019-04-29 09:47:25 GMT
...
@note HINTS:
 - Run soapcpp2 on myWeather.h to generate the SOAP/XML processing logic.
...
/// - ns1__ArrayOfString* soap_new_ns1__ArrayOfString(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getSupportCity* soap_new__ns1__getSupportCity(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getSupportCityResponse* soap_new__ns1__getSupportCityResponse(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getSupportProvince* soap_new__ns1__getSupportProvince(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getSupportProvinceResponse* soap_new__ns1__getSupportProvinceResponse(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getSupportDataSet* soap_new__ns1__getSupportDataSet(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getSupportDataSetResponse* soap_new__ns1__getSupportDataSetResponse(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getSupportDataSetResponse_getSupportDataSetResult* soap_new__ns1__getSupportDataSetResponse_getSupportDataSetResult(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getWeatherbyCityName* soap_new__ns1__getWeatherbyCityName(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getWeatherbyCityNameResponse* soap_new__ns1__getWeatherbyCityNameResponse(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getWeatherbyCityNamePro* soap_new__ns1__getWeatherbyCityNamePro(soap*, int num) allocate array and default initialize values
...
/// - _ns1__getWeatherbyCityNameProResponse* soap_new__ns1__getWeatherbyCityNameProResponse(soap*, int num) allocate array and default initialize values
...
/// - _ns1__DataSet* soap_new__ns1__DataSet(soap*, int num) allocate array and default initialize values
